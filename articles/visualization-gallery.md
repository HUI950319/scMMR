...
scMMR includes 18+ publication-ready visualization functions. This
gallery provides a quick reference for each function with usage
examples.
...
Observed/Expected ratio heatmap highlighting cell type enrichment per
group.
...
**Key parameters:** `by`, `fill`, `palette`, `display`
(“value”/“symbol”/“both”), `show.pvalue`, `p.method` (“chisq”/“fisher”),
`return.data`
...
**Key parameters:** `by`, `fill`, `colors`, `palette`, `flow.alpha`,
`bar.width`, `show.label`, `show.pct`
...
**Key parameters:** Same as PlotAlluvia plus `curve.type`
(“linear”/“spline”)
...
**Key parameters:** `ref`, `query_meta`, `ref_emb`, `query_emb`,
`color_by`, `facet_by`, `colors`, `density.color`
...
**Key parameters:** `which`, `palette`, `row_order`, `col_order`,
`base_size`
...
**Key parameters:** `top_k`, `display` (“lollipop”/“bar”), `palette`,
`base_size`

### PlotRankScatter – Rank Scatter Plot

Generic scatter for visualizing feature scores (gene importance, module
scores, pathway NES).
...
**Key parameters:** `top_k`, `display` (“lollipop”/“bar”),
`sig_threshold`, `palette`, `base_size`
...
**Key parameters:** `fdr_threshold`, `colors`, `show_boxplot`,
...
**Key parameters:** `type` (“dot”/“volcano”), `top_n`, `top_by`,
`logfc.cutoff`, `pval.cutoff`, `label`
...
**Key parameters:** `top.n`, `order_by`, `use.padj`, `facet_by`,
`colors`
...
**Key parameters:** `use.padj`, `p.cutoff`, `cor.cutoff`, `label`,
`label.n`
...
**Key parameters:** `emb.cols`, `prop.data`, `method`, `group.by`,
`base_size`
...
**Key parameters:** `features`, `pseudotime_col`, `method`
(“loess”/“gam”), `group.by`, `colors`
...
(“all”/“elbow”/“cumvar”/“knn”/“distcor”/“silhouette”), `base_size`
